...
class Configuration(object):
    ...
    def __init__(self, name = None, sigma = None, E_DFT = None, E_fit = None, E_CE = None, n_nodes = None, atoms = None):
        self.name = name
        self.sigma = sigma
        self.E_DFT = E_DFT
        self.E_fit = E_fit
    ...
    def from_vasp(cls, name = None, sigma = None, n_nodes = None, path = './'):
        ...
        try:
            ...
            E_DFT = None
        return cls(name = name, sigma = sigma, E_DFT = E_DFT, n_nodes = n_nodes, atoms = atoms)
